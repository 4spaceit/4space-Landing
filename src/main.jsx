  ...
  <React.StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/en/retail" element={<App data={dataRetailEn} video={RetailVideo} videoM={RetailVideo} bg={"https://4spacewp.com/wp-content/uploads/2018/03/VR-Park-5-scaled.jpg"} />} />
        ...
        <Route path="/en/commercial" element={<App data={dataCommercialEn} video={CommercialVideo} videoM={CommercialVideo} bg={"https://4spacewp.com/wp-content/uploads/2021/02/4space-office-01-2.jpg"} />} />
        <Route path="/en/branding" element={<App data={dataBrandingEn} video={BrandingVideo} videoM={BrandingVideo} bg={"./images/first.jpg"} />} />
        ...
        <Route path="/ar/retail" element={<LandingAr data={dataRetailAr} video={RetailVideo} videoM={RetailVideo} bg={"https://4spacewp.com/wp-content/uploads/2018/03/VR-Park-5-scaled.jpg"} />} />
        ...
        <Route path="/ar/commercial" element={<LandingAr data={dataCommercialAr} video={CommercialVideo} videoM={CommercialVideo} bg={"https://4spacewp.com/wp-content/uploads/2021/02/4space-office-01-2.jpg"} />} />
        <Route path="/ar/branding" element={<LandingAr data={dataBrandingAr} video={BrandingVideo} videoM={BrandingVideo} bg={"./images/first.jpg"} />} />
        ...
        <Route path="/ru/commercial" element={<LandingRu data={dataCommercialRu}  video={CommercialVideo} videoM={CommercialVideo} bg={"https://4spacewp.com/wp-content/uploads/2021/02/4space-office-01-2.jpg"} />} />
        <Route path="/ru/branding" element={<LandingRu data={dataBrandingRu} video={BrandingVideo} videoM={BrandingVideo} bg={"./images/first.jpg"} />} />
