        ...
        >
          ...
          <div className={`navbar-menu link-touch ${open ? "is-active" : ""}`}>
            <div className="navbar-end">
              ...
              <Link rel="nofollow" to="our-clients" offset={-50} spy={true} smooth={true} className="navbar-item" onClick={() => setOpen(false)} > Our Clients </Link>
              <Link rel="nofollow" to="testimonial" offset={-50} spy={true} smooth={true} className="navbar-item" onClick={() => setOpen(false)} > Testimonial </Link>
